                        ...
                        Expanded(
                          child: Obx(
                                ...
                                Marquee(
                                  ...
                                  id: "${albumController.album.value.title
                              ...
                              child: ListView.builder(
                                ...
                                itemBuilder: (_, index) {
                                  if (index == 0) {
                                        ...
                                        child: Row(
                                          children: [
                                            ...
                                            IconButton(
                                              ...
                                              splashRadius: 10,
                                              onPressed: () async {
                                                await AppPlatformService
                                                    .shareText(
                                                  "https://youtube.com/playlist?list=${albumController
                                                      .album.value
                                                      .audioPlaylistId}",
                                                );
                                              },
                                    ...
                                    return SizedBox(
                                      height: albumController.isSearchingOn
                                          .isTrue
                                          ? 60
                                          : 40,
                                      child: Padding(
                                    ...
                                    child: SongListTile(
                                      onTap: () async {
                                        await playerController.playPlayListSong(
                                          ...
                                          index - 3,
                                          playFrom: PlayingFrom(
                                            name: albumController.album.value
                                                .title,
                                            type: PlayingFromType.ALBUM,
                                          ),
                                        );
