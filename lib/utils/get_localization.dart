...
class Languages {
  Map<String, Map<String, String>> get keys => {
    ...
    "az": {
      ...
      "blacklistPlaylistResetAlert": "Uğurla sıfırlandı!",
      "language": "Dil",
      "search": "Axtarış",
      ...
      "errorOccurredAlert": "Xəta baş verdi!",
      "songs": "Mahnılar",
      "high": "Yüksək",
    ...
    "bn": {
      ...
      "pipedPlaylistSyncAlert": "পাইপড প্লেলিস্ট সিঙ্ক হয়েছে!",
    ...
    "ca": {
      ...
      "errorOccurredAlert": "Hi ha hagut un error!",
      "pipedPlaylistSyncAlert": "Llista de reproducció de Piped sincronitzada!",
    ...
    "cs": {
      ...
      "blacklistPlaylistResetAlert": "Resetování proběhlo úspěšně!",
      "language": "Jazyk",
      "search": "Hledat",
      "skipSilenceDes": "Při přehrávání hudby se přeskočí ticho",
      "playNext": "Přehrát jako další",
      "errorOccurredAlert": "Došlo k nějaké chybě!",
      "songs": "Skladby",
      "high": "Vysoká 🔥",
    ...
    "en": {
      ...
      "errorOccurredAlert": "Some error occured!",
      "pipedPlaylistSyncAlert": "Piped playlist synced!",
    ...
    "eo": {
      ...
      "upNext": "Sekva",
      "enabled": "Ebligita",
      "pipedPlaylistSyncAlert": "Piped ludlisto sinkroniĝis!",
      "Piped": "Piped",
    ...
    "fi": {
      ...
      "pipedPlaylistSyncAlert": "Synkronoitu Piped-soittolista!",
      "search": "Etsi",
      ...
      "errorOccurredAlert": "Tapahtui virhe!",
    ...
    "fr": {
      ...
      "for1": "pour",
      "about": "À propos",
      "errorOccurredAlert": "Une erreur s'est produite !",
    ...
    "gl": {
      ...
      "errorOccurredAlert": "Produciuse un erro!",
      "pipedPlaylistSyncAlert": "Listaxe canalizada sincronizada!",
    ...
    "hi": {
      ...
      "errorOccurredAlert": "कुछ त्रुटि हुई!",
      ...
      "reset": "रिसेट",
      "blacklistPlaylistResetAlert": "सफलतापूर्वक रिसेट हुआ!",
    ...
    "ia": {
      ...
      "exportDownloadedFiles": "Exportar files discargate",
    ...
    "id": {
      ...
      "blacklistPlaylistResetAlert": "Setel ulang berhasil!",
      "language": "Bahasa",
      "search": "Cari",
      ...
      "errorOccurredAlert": "Terjadi kesalahan!",
      "songs": "Lagu",
      "high": "Tinggi",
      ...
      "pipedPlaylistSyncAlert": "Daftar putar yang disalurkan tersinkronkan!",
    ...
    "it": {
      ...
      "for1": "per",
      "results": "Risultati",
      "errorOccurredAlert": "C'è stato un errore!",
      ...
      "password": "Password",
      "blacklistPlaylistResetAlert": "Reset eseguito correttamente!",
    ...
    "ja": {
      ...
      "sleepTimer": "スリープタイマー",
      "pipedPlaylistSyncAlert": "Pipedの再生リストを同期しました！",
      ...
      "exportDownloadedFiles": "ダウンロード済みファイルをエクスポート",
    ...
    "ko": {
      ...
      "pipedPlaylistSyncAlert": "Piped 플레이리스트 동기화됨!",
      ...
      "reset": "초기화",
      "blacklistPlaylistResetAlert": "초기화 성공!",
      ...
      "errorOccurredAlert": "알 수 없는 오류가 생겼습니다!",
      ...
      "exportDownloadedFiles": "다운로드한 파일을 내보내기",
      "exportDownloadedFilesDes": "인앱 디렉토리에 있는 다운로드한 파일들을 외부 디렉토리로 옮기려면 클릭하세요",
    ...
    "nb_NO": {
      ...
      "username": "Brukernavn",
      "reset": "Nullstille",
      "blacklistPlaylistResetAlert": "Tilbakestill vellykket!",
      "password": "Passord",
    ...
    "nl": {
      ...
      "blacklistPlaylistResetAlert": "Successvolle reset!",
      "password": "Wachtwoord",
    ...
    "pa": {
      ...
      "blacklistPlaylistResetAlert": "ਸਫਲਤਾਪੂਰਵਕ ਰੀਸੈਟ ਹੋਇਆ!",
      "language": "ਭਾਸ਼ਾ",
      "search": "ਖੋਜ ਕਰੋ",
      "skipSilenceDes": "ਸੰਗੀਤ ਪਲੇਬੈਕ ਵਿੱਚ ਚੁੱਪ ਛੱਡ ਦਿੱਤੀ ਜਾਵੇਗੀ",
      "playNext": "ਅਗਲਾ ਚਲਾਓ",
      "errorOccurredAlert": "ਕੁਝ ਤਰੁੱਟੀ ਆਈ ਹੈ!",
      "songs": "ਗੀਤ",
      "high": "ਉੱਚ",
      ...
      "upNext": "ਅਗਲਾ ਗੀਤ",
      "pipedPlaylistSyncAlert": "ਪਾਈਪਡ ਪਲੇਲਿਸਟ ਸਿੰਕ ਕੀਤੀ ਗਈ!",
    ...
    "pl": {
      ...
      "errorOccurredAlert": "Wystąpił błąd!",
      ...
      "pipedPlaylistSyncAlert": "Zsynchronizowano playlisty z Piped!",
    ...
    "ro": {
      ...
      "backup": "Backup",
      "letsStart": "Sa incepem..",
      "hintApiUrl": "API URL la instanța Piped",
      "closeApp": "Închideți aplicația",
      "blacklistPlaylistResetAlert": "Resetare cu succes!",
    ...
    "ru": {
      ...
      "errorOccurredAlert": "Произошла ошибка!",
    ...
    "sk": {
      ...
      "blacklistPlaylistResetAlert": "Resetovanie úspešné!",
    ...
    "sr": {
      ...
      "blacklistPlaylistResetAlert": "Успешно ресетовано!",
      "language": "Језик",
      "search": "Претрага",
      "skipSilenceDes": "Тишина ће бити прескочена током пуштања музике",
      "playNext": "Пусти следеће",
      "errorOccurredAlert": "Дошло је до грешке!",
      "songs": "Песме",
      "high": "Високо",
    ...
    "sv": {
      ...
      "exportDownloadedFiles": "Exportera nedladdade filer",
      "export": "Exportera",
      "scanning": "Söker...",
      "close": "Stäng",
      ...
      "errorOccurredAlert": "Ett fel uppstod!",
      "pipedPlaylistSyncAlert": "Piped spellista synkroniserad!",
    ...
    "ta": {
      ...
      "errorOccurredAlert": "சில பிழை ஏற்பட்டது!",
      ...
      "pipedPlaylistSyncAlert": "குழாய் பிளேலிச்ட் ஒத்திசைக்கப்பட்டது!",
    ...
    "tr": {
      ...
      "disabled": "Devre dışı",
      "blacklistPlaylistResetAlert": "Sıfırlama başarılı!",
      "language": "Dil seçimi",
      "search": "Ara",
      "skipSilenceDes": "Şarkı çalma sırasında sessizlik atlanacak",
      "errorOccurredAlert": "Bir hata oluştu!",
      "high": "Yüksek",
    ...
    "vi": {
      ...
      "errorOccurredAlert": "Có vài lỗi xảy ra!",
    ...
    "zh_Hans": {
      ...
      "blacklistPlaylistResetAlert": "重设成功！",
      "language": "语言",
      ...
      "pipedPlaylistSyncAlert": "Piped 播放列表已同步！",
      "cancelTimer": "取消定时器",
      ...
      "exportDownloadedFiles": "输出已下载的文件",
      ...
      "exportDownloadedFilesDes": "单击此处将下载的文件从 inApp 目录导出到外部目录",
      ...
      "backupMsg": "备份已成功保存！",
      "queueRearrangingDeniedMessage": "随机播放启用时无法手动重排队列",
      "openIn": "打开于",
    ...
    "zh_Hant": {
      ...
      "queueRearrangingDeniedMessage": "當隨機播放模式已啟用時，無法重新排列播放佇列",
      ...
      "pipedPlaylistSyncAlert": "已同步Piped播放清單！",
      ...
      "blacklistPlaylistResetAlert": "重設成功！",
