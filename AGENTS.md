...
- Inspect the existing implementation before changing behavior. Start with `rg` and targeted file reads so the current Flutter/GetX/Hive patterns drive the solution.
